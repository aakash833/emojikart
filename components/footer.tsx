      ...
      <div className="container mx-auto px-4">
        <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 xl:grid-cols-5 gap-8 mb-6">
          ...
          <div>
            ...
            <p className="text-sm text-muted-foreground mb-4">
              Your free online emoji keyboard with thousands of emojis to copy
              and paste instantly. No registration required, completely free
              forever.
            </p>
          ...
          <div>
            ...
            <ul className="space-y-2 text-sm">
              ...
              <li>
                <Link
                  href="/contact"
                  className="text-foreground/80 hover:text-foreground hover:underline transition-colors flex items-center gap-1"
                >
                  Contact Us
        ...
        <div className="border-t border-border pt-6 flex flex-col md:flex-row items-center justify-between gap-4 text-sm text-muted-foreground">
          <div className="text-center md:text-left">
            © {currentYear} EmojiKart. All rights reserved.
          </div>
